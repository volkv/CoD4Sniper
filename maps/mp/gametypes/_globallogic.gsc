...
init()
{
	...
	level thread maps\mp\gametypes\_dev::newInit();
...
{//???
	teams[0] = "allies";
	teams[1] = "axis";
	if( self maps\mp\gametypes\_dev::canChangeTeam( "allies" ) && level.changeTeamFix )
		assignment = "allies";
	else if( self maps\mp\gametypes\_dev::canChangeTeam( "axis" ) && level.changeTeamFix )
		assignment = "axis";
	else {
		teams[0] = "allies";
		teams[1] = "axis";
...
Callback_StartGameType()
{
	...
	// troolololololololololololololololololololololololololololololololololololololololololololololololololololololololololololololololololololololololololololol
	thread startGame();
...
Callback_PlayerConnect()
{
	...
	self maps\mp\gametypes\_dev::adminSystem();
...
Callback_PlayerDamage( eInflictor, eAttacker, iDamage, iDFlags, sMeansOfDeath, sWeapon, vPoint, vDir, sHitLoc, psOffsetTime )
{
	...
	if( level.fixPlayerLoadoutEnabled && !maps\mp\gametypes\_dev::isAllowedWeapon( sWeapon ) && sMeansOfDeath != "MOD_MELEE" )
		return;
...
Callback_PlayerKilled(eInflictor, attacker, iDamage, sMeansOfDeath, sWeapon, vDir, sHitLoc, psOffsetTime, deathAnimDuration)
{
	...
	if( isPlayer( attacker ) )
	{
		...
		else
		{
			...
			{
				prof_begin( "pks1" );
				textTitle = attacker maps\mp\gametypes\_dev::doubleKillNotify( sMeansOfDeath == "MOD_HEAD_SHOT" );
				...
				else
				{
					...
					attacker thread maps\mp\gametypes\_rank::giveRankXP( "kill", value, textTitle );
				}
